...
public class WLRuntimeFunctionHelper
{
    ...
    public WLRuntimeFunctionHelper(TypeDefinition program, MethodReference stringEqual, MethodReference objEquals, MethodReference toString, CilTypeManager typeManager, bool debug = false)
    {
        _program = program;
    ...
    public MethodDefinition CreateWLEquals()
    {
        ...
        var arg1 = new ParameterDefinition(dotnetObject);
        var arg2 = new ParameterDefinition(dotnetObject);
        ...
        var referenceEqualsStart = processor.Create(OpCodes.Ldarg, arg1);
        var returnInstr = processor.Create(OpCodes.Ret);

        // if arg1 is string && arg2 is string
        {
            var stringType = typeManager.GetType(TypeSymbol.String);
            processor.Emit(OpCodes.Ldarg, arg1);
            processor.Emit(OpCodes.Isinst, stringType);
            ...
            processor.Emit(OpCodes.Brfalse, referenceEqualsStart);
            processor.Emit(OpCodes.Ldarg, arg1);
            processor.Emit(OpCodes.Ldarg, arg2);
        ...
        processor.Append(referenceEqualsStart);
        processor.Emit(OpCodes.Ldarg, arg2);
