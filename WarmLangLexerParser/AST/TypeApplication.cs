...
public sealed class TypeApplication : ExpressionNode
{
    public TypeApplication(Access access, SyntaxToken openAngle, List<TypeSyntaxNode> typeParams, SyntaxToken closeAngle)
